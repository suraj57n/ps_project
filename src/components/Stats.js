              ...
              <div className="row p-3">
                ...
                <div className="col-sm-6 py-5">
                  <div className="d-flex justify-content-end">
                    <img src="https://img.freepik.com/premium-vector/business-growth-isometric-web-concept-people-work-together-project-analyze-financial-statistics_9209-7101.jpg?w=2000" alt="statistics" width="100%" height="50%" />
                  </div>
                </div>
              </div>
            </div>
